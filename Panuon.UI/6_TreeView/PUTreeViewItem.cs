...
namespace Panuon.UI
{
    public class PUTreeViewItem : TreeViewItem
    {
        ...
        public static readonly DependencyProperty CoverBrushProperty = DependencyProperty.Register("CoverBrush", typeof(SolidColorBrush), typeof(PUTreeViewItem), new PropertyMetadata(new SolidColorBrush((Color)ColorConverter.ConvertFromString("#22666666"))));
